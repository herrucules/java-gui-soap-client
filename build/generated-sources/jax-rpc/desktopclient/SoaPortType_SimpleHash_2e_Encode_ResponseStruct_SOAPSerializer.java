...
public class SoaPortType_SimpleHash_2e_Encode_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public SoaPortType_SimpleHash_2e_Encode_ResponseStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public java.lang.Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        desktopclient.SoaPortType_SimpleHash_2e_Encode_ResponseStruct instance = new desktopclient.SoaPortType_SimpleHash_2e_Encode_ResponseStruct();
        desktopclient.SoaPortType_SimpleHash_2e_Encode_ResponseStruct_SOAPBuilder builder = null;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_return_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new desktopclient.SoaPortType_SimpleHash_2e_Encode_ResponseStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(java.lang.Object obj, XMLWriter writer, SOAPSerializationContext context) throws java.lang.Exception {
        desktopclient.SoaPortType_SimpleHash_2e_Encode_ResponseStruct instance = (desktopclient.SoaPortType_SimpleHash_2e_Encode_ResponseStruct)obj;
